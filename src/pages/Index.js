...
const Index = () => {
    ...
    return (_jsxs("div", { className: "min-h-screen bg-gray-50", children: [_jsx(IndexHeader, {}), _jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12", children: [_jsx(HeroSection, {}), _jsx(DebugSection, {}), _jsx(FeatureCards, {}), _jsx(FeatureHighlights, {})] }), _jsx(IndexFooter, {})] }));
};
