...
export const useFranchiseeFilters = (franchisees) => {
    ...
    const filteredFranchisees = useMemo(() => {
        ...
        if (filters.search) {
            ...
            filtered = filtered.filter(franchisee => franchisee.franchisee_name.toLowerCase().includes(searchLower) ||
        ...
        if (filters.hasEmail) {
            if (filters.hasEmail === 'yes') {
                filtered = filtered.filter(franchisee => franchisee.profiles && franchisee.profiles.email);
            }
